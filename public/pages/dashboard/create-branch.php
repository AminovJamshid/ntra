                                ...
                                <form id="branch-create" action="/branch/create" method="post" enctype="multipart/form-data">
                                    <div class="grid grid-cols-12 gap-5">
                                        ...
                                        <div class="col-span-12">
                                            ...
                                            <input name="branch" id="branch" type="text" class="form-input mt-2" placeholder="Add branch :">
                                        </div>

                                        <div class="col-span-12 mt-4">
                                            <label for="branch_address" class="font-medium">Branch Address</label>
                                            <input name="branch_address" id="branch_address" type="text" class="form-input mt-2" placeholder="Add branch address :">
                                        </div>
